...
- Chat-Tür ist Titel + Composer, optional eine Projektzeile; Freigaben/Blocker/Fortsetzen erscheinen im Chat nur bei echter Kernel-Handlung und schreiben denselben Operate-Pfad wie Arbeit
...
- Offene Projektfläche: Desktop behält horizontale Statusspalten; bis 768px ist die Planung eine senkrechte Kartenwand (Titel + Statuschip, Ideen-Zeile gegen die Element-API)
