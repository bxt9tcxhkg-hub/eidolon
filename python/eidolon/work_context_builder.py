...
from eidolon.core.runtime_problems import collect_visible_problems
...
def build_unified_work_context(message: str, session: dict[str, Any] | None, source: str, workspace_payload: dict[str, Any] | None, llm_status: dict[str, Any] | None, capability_payload: list[dict[str, Any]] | None, user_model: dict[str, Any] | None, operate_snapshot: dict[str, Any] | None = None) -> dict[str, Any]:
    ...
    return {
        ...
        'response_policy': {
            'default_open_intent_mode': 'brief_cowork',
            'max_work_reply_lines': 5,
            'max_next_actions': 1,
            'prefer_board_over_catalog': True,
            'forbid_direction_schema': True,
            'forbid_generic_help_offer': True,
            'ask_only_on_real_blocker': True,
        },
        ...
        'runtime_problems': collect_visible_problems(llm_status=llm_status),
    }
