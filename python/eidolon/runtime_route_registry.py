...
from eidolon.core.llm_backend import SYSTEM_PROMPT, configure_from_settings, get_ollama_models, get_openai_models
...
def register_routes(runtime_app):
    ...
    register_chat_and_code_routes(
        ...
        chat_runtime_truth_reply=lambda message, runtime_context=None: chat_runtime_truth_reply(message, runtime_app._ns('llm_backend', runtime_app.services.llm_backend), runtime_context),
    ...
    register_settings_routes(runtime_app.app, get_settings_store=lambda: runtime_app._ns('settings_store', runtime_app.services.settings_store), reconfigure_llm=lambda: configure_from_settings(runtime_app._ns('settings_store', runtime_app.services.settings_store).get_area('llm'), runtime_app.services.llm_backend))
