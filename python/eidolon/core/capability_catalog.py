...
from eidolon.core.capability_checks import browser_control_available, cmd_available, evidence_store_available, filesystem_readable, filesystem_writable, hud_runtime_available, image_generation_available, mesh_quic_available, module_available, ollama_available
...
def build_default_capabilities() -> list[Capability]:
    return [
        ...
        Capability('skills.runtime', 'Skill Runtime', provider='local', _check_fn=lambda: False, detail='Skill-Registry ist nicht an Chat oder Operate angebunden'),
